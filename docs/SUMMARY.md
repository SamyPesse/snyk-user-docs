...
* [Getting started](getting-started/README.md)
  ...
  * [Quickstart](getting-started/quickstart/README.md)
    * [A new page](getting-started/quickstart/a-new-page.md)
    * [Another new page](getting-started/quickstart/another-new-page.md)
    * [Another page 2](getting-started/quickstart/another-page-2.md)
    * [Another page 3](getting-started/quickstart/another-page-3.md)
...
* [Integrate with Snyk](integrations/README.md)
  ...
  * [Git repositories (SCMs)](integrations/git-repository-scm-integrations/README.md)
    ...
    * [Bitbucket Cloud integration](integrations/git-repository-scm-integrations/bitbucket-cloud-legacy-integration.md)
  ...
  * [Package repository integrations](integrations/package-repository-integrations/README.md)
    ...
    * [Nexus Repository Manager setup](integrations/package-repository-integrations/nexus-repo-manager-setup/README.md)
      * [Nexus Repository Manager for Maven](integrations/package-repository-integrations/nexus-repo-manager-setup/artifactory-registry-for-maven-1.md)
      * [Nexus Repository Manager for npm](integrations/package-repository-integrations/nexus-repo-manager-setup/artifactory-registry-for-npm-1.md)
  ...
  * [Cloud platforms](integrations/cloud-platforms/README.md)
    * [AWS Integration](integrations/cloud-platforms/aws-integration/README.md)
      * [AWS Integration: Web UI](integrations/cloud-platforms/aws-integration/aws-integration-web-ui/README.md)
        * [Step 1: Download IAM role IaC template (Web UI)](integrations/cloud-platforms/aws-integration/aws-integration-web-ui/step-1-download-iam-role-iac-template-web-ui.md)
        * [Step 2: Create the Snyk IAM role](integrations/cloud-platforms/aws-integration/aws-integration-web-ui/step-2-create-the-snyk-iam-role.md)
        * [Step 3: Create and scan a Cloud Environment (Web UI)](integrations/cloud-platforms/aws-integration/aws-integration-web-ui/step-3-create-and-scan-a-snyk-cloud-environment-web-ui.md)
      * [AWS Integration: API](integrations/cloud-platforms/aws-integration/snyk-cloud-for-aws-api/README.md)
        * [Step 1: Download IAM role IaC template (API)](integrations/cloud-platforms/aws-integration/snyk-cloud-for-aws-api/step-1-download-iam-role-iac-template.md)
        * [Step 2: Create the Snyk IAM role (API)](integrations/cloud-platforms/aws-integration/snyk-cloud-for-aws-api/step-2-create-the-snyk-iam-role-api.md)
        * [Step 3: Create and scan a Cloud Environment (API)](integrations/cloud-platforms/aws-integration/snyk-cloud-for-aws-api/step-3-create-and-scan-a-snyk-cloud-environment.md)
    * [Azure integration for cloud configurations](integrations/cloud-platforms/azure-integration-for-cloud-configurations/README.md)
      * [Azure Integration: Web UI](integrations/cloud-platforms/azure-integration-for-cloud-configurations/azure-integration-web-ui/README.md)
        * [Step 1: Download Azure app registration IaC template or script (Web UI)](integrations/cloud-platforms/azure-integration-for-cloud-configurations/azure-integration-web-ui/step-1-download-azure-app-registration-iac-template-or-script-web-ui.md)
        * [Step 2: Create the Azure AD app registration](integrations/cloud-platforms/azure-integration-for-cloud-configurations/azure-integration-web-ui/step-2-create-the-azure-ad-app-registration.md)
        * [Step 3: Create and scan a Cloud Environment for Azure (Web UI)](integrations/cloud-platforms/azure-integration-for-cloud-configurations/azure-integration-web-ui/step-3-create-and-scan-a-snyk-cloud-environment-for-azure-web-ui.md)
      * [Azure Integration: API](integrations/cloud-platforms/azure-integration-for-cloud-configurations/snyk-cloud-for-azure-api/README.md)
    ...
    * [Google Cloud integration](integrations/cloud-platforms/google-cloud-integration/README.md)
      * [Google Cloud Integration: Web UI](integrations/cloud-platforms/google-cloud-integration/google-cloud-integration-web-ui/README.md)
        ...
        * [Step 3: Create and scan a Cloud Environment for Google (Web UI)](integrations/cloud-platforms/google-cloud-integration/google-cloud-integration-web-ui/step-3-create-and-scan-a-snyk-cloud-environment-for-google-web-ui.md)
      * [Google Cloud Integration: API](integrations/cloud-platforms/google-cloud-integration/google-cloud-integration-api/README.md)
        * [Step 1: Download service account IaC template (API)](integrations/cloud-platforms/google-cloud-integration/google-cloud-integration-api/step-1-download-service-account-iac-template-api.md)
        * [Step 2: Create the Google service account (API)](integrations/cloud-platforms/google-cloud-integration/google-cloud-integration-api/step-2-create-the-google-service-account-api.md)
        * [Step 3: Create and scan a Cloud Environment for Google (API)](integrations/cloud-platforms/google-cloud-integration/google-cloud-integration-api/step-3-create-and-scan-a-snyk-cloud-environment-for-google-api.md)
...
* [Scan application code](scan-application-code/README.md)
  ...
  * [Snyk Code](scan-application-code/snyk-code/README.md)
    ...
    * [Custom rules (beta)](scan-application-code/snyk-code/custom-rules-beta/README.md)
      ...
      * [Getting started with custom rules](scan-application-code/snyk-code/custom-rules-beta/getting-started-with-custom-rules.md)
      ...
      * [Templates and predicates](scan-application-code/snyk-code/custom-rules-beta/templates-and-predicates/README.md)
        * [Predefined predicates and templates](scan-application-code/snyk-code/custom-rules-beta/templates-and-predicates/list-of-built-in-predicates-and-templates.md)
      * [Query examples](scan-application-code/snyk-code/custom-rules-beta/query-examples.md)
      * [Best Practices](scan-application-code/snyk-code/custom-rules-beta/best-practices.md)
    ...
    * [Deployment options for Snyk Code](scan-application-code/snyk-code/deployment-options/README.md)
      * [Snyk Code Local Engine](scan-application-code/snyk-code/deployment-options/snyk-code-local-engine/README.md)
        ...
        * [CLI and IDEs with the Snyk Code Local Engine](scan-application-code/snyk-code/deployment-options/snyk-code-local-engine/cli-and-ides-with-the-snyk-code-local-engine.md)
...
* [Scan containers](scan-containers/README.md)
  ...
  * [Using Snyk Container](scan-containers/using-snyk-container/README.md)
    * [Base image detection](scan-containers/using-snyk-container/base-image-detection.md)
    * [Image layer information](scan-containers/using-snyk-container/image-layer-information.md)
    * [Detecting application vulnerabilities in container images](scan-containers/using-snyk-container/detecting-application-vulnerabilities-in-container-images.md)
    * [Analysis and fixes for your images from the Snyk Web UI](scan-containers/using-snyk-container/analysis-and-remediation-for-your-images-from-the-snyk-app.md)
    * [Custom Base Image Recommendations](scan-containers/using-snyk-container/custom-base-image-recommendations/README.md)
      * [Case study for Custom Base Image Recommendations](scan-containers/using-snyk-container/custom-base-image-recommendations/case-study-for-custom-base-image-recommendations.md)
      * [Versioning Schema options](scan-containers/using-snyk-container/custom-base-image-recommendations/versioning-schema-options.md)
      * [Custom Versioning Schema for Custom Base Images](scan-containers/using-snyk-container/custom-base-image-recommendations/custom-versioning-schema-for-custom-base-images.md)
    * [Container Project grouping in Project tab](scan-containers/using-snyk-container/container-project-grouping-in-project-tab.md)
...
* [Scan cloud configurations](scan-cloud-configurations/README.md)
  * [Supported IaC and cloud providers](scan-cloud-configurations/supported-iac-and-cloud-providers.md)
  * [Snyk Infrastructure as Code](scan-cloud-configurations/snyk-infrastructure-as-code/README.md)
    * [Getting started with Snyk Infrastructure as Code (IaC)](scan-cloud-configurations/snyk-infrastructure-as-code/getting-started-snyk-iac.md)
    * [Using Snyk IaC with the Web UI](scan-cloud-configurations/snyk-infrastructure-as-code/using-snyk-iac-via-web.md)
    * [Snyk CLI for Infrastructure as Code](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/README.md)
      * [Test your IaC files](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/README.md)
        * [Test your Terraform files with Snyk CLI](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-terraform-files-with-snyk-cli.md)
        * [Test your CloudFormation files with Snyk CLI](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-cloudformation-files-with-snyk-cli.md)
        * [Test your AWS CDK files with Snyk CLI](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-aws-cdk-files-with-snyk-cli.md)
        * [Test your Kubernetes files with Snyk CLI](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-kubernetes-files-with-snyk-cli.md)
        * [Test your ARM files with Snyk CLI](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-arm-files-with-snyk-cli.md)
        * [Test your Kustomize files with Snyk CLI](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-kustomize-files-with-snyk-cli.md)
        * [Test your Helm charts with Snyk CLI](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-helm-charts-with-snyk-cli.md)
        * [Test your Serverless files with Snyk CLI](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/test-your-iac-files/test-your-serverless-files-with-snyk-cli.md)
      * [Share CLI results with the Snyk Web UI](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/share-cli-results-with-the-snyk-web-ui.md)
      * [IaC ignores using the .snyk policy file](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/iac-ignores-using-the-.snyk-policy-file.md)
      * [IaC exclusions using the command line](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/iac-exclusions-using-the-command-line.md)
      * [Understanding the IaC CLI test results](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/understanding-the-cli-test-output/README.md)
        * [Snyk IaC CLI test results (v. 1.939.0 and later)](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/understanding-the-cli-test-output/snyk-iac-cli-test-results-v.-1.939.0-and-later.md)
        * [Snyk IaC CLI test results (v. 1.938.0 and earlier)](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-cli-for-infrastructure-as-code/understanding-the-cli-test-output/snyk-iac-cli-test-results-v.-1.938.0-and-earlier.md)
    * [Snyk Infrastructure as Code with Broker for self-hosted Git](scan-cloud-configurations/snyk-infrastructure-as-code/snyk-infrastructure-as-code-with-broker-for-self-hosted-git.md)
    * [Scan Terraform files](scan-cloud-configurations/snyk-infrastructure-as-code/scan-terraform-files/README.md)
      ...
      * [Scan and fix security issues in Terraform files](scan-cloud-configurations/snyk-infrastructure-as-code/scan-terraform-files/scan-and-fix-security-issues-in-terraform-files.md)
      * [Terraform variables support](scan-cloud-configurations/snyk-infrastructure-as-code/scan-terraform-files/terraform-variables-support.md)
    ...
    * [Scan CloudFormation files](scan-cloud-configurations/snyk-infrastructure-as-code/scan-cloudformation-files/README.md)
      ...
      * [Scan and fix security issues in your CloudFormation files](scan-cloud-configurations/snyk-infrastructure-as-code/scan-cloudformation-files/scan-and-fix-security-issues-in-your-cloudformation-files.md)
    * [Scan Kubernetes configuration files](scan-cloud-configurations/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/README.md)
      * [Configure integration to find security issues in Kubernetes configuration files](scan-cloud-configurations/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/configure-integration-for-security-issues-in-kubernetes-configuration-files.md)
      * [Scan and fix security issues in Kubernetes configuration files](scan-cloud-configurations/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/scan-and-fix-security-issues-in-kubernetes-configuration-files.md)
      * [Scan and fix security issues in Helm Charts](scan-cloud-configurations/snyk-infrastructure-as-code/scan-kubernetes-configuration-files/scan-and-fix-security-issues-in-helm-charts.md)
    ...
    * [Build your own custom rules](scan-cloud-configurations/snyk-infrastructure-as-code/custom-rules/README.md)
      ...
      * [Getting started with the SDK](scan-cloud-configurations/snyk-infrastructure-as-code/custom-rules/getting-started-with-the-sdk/README.md)
  ...
  * [Integrated IaC with cloud context](scan-cloud-configurations/integrated-iac-with-cloud-context/README.md)
    ...
    * [Test your Integrated IaC files with Snyk CLI](scan-cloud-configurations/integrated-iac-with-cloud-context/test-your-integrated-iac-files-with-snyk-cli.md)
    * [Adding cloud context to your Integrated IaC tests](scan-cloud-configurations/integrated-iac-with-cloud-context/adding-cloud-context-to-your-integrated-iac-tests.md)
    ...
    * [Snyk environments](scan-cloud-configurations/integrated-iac-with-cloud-context/snyk-environments/README.md)
      ...
      * [Scan a cloud environment](scan-cloud-configurations/integrated-iac-with-cloud-context/snyk-environments/scan-a-cloud-environment.md)
      * [Update a cloud environment](scan-cloud-configurations/integrated-iac-with-cloud-context/snyk-environments/update-a-cloud-environment.md)
    ...
    * [Supported resources for Snyk cloud context](scan-cloud-configurations/integrated-iac-with-cloud-context/supported-resources-for-snyk-cloud-context/README.md)
    ...
    * [Build your own IaC to cloud custom rules](scan-cloud-configurations/integrated-iac-with-cloud-context/build-your-own-iac-to-cloud-custom-rules/README.md)
      ...
      * [Create a Custom Rule](scan-cloud-configurations/integrated-iac-with-cloud-context/build-your-own-iac-to-cloud-custom-rules/create-a-custom-rule.md)
      * [(Recommended) Write a Custom Rule Spec (Unit Test)](scan-cloud-configurations/integrated-iac-with-cloud-context/build-your-own-iac-to-cloud-custom-rules/recommended-write-a-custom-rule-spec-unit-test.md)
      * [(Recommended) Test your Custom Rule](scan-cloud-configurations/integrated-iac-with-cloud-context/build-your-own-iac-to-cloud-custom-rules/recommended-test-your-custom-rule.md)
      * [Build, bundle, and upload your Custom Rules](scan-cloud-configurations/integrated-iac-with-cloud-context/build-your-own-iac-to-cloud-custom-rules/build-bundle-and-upload-your-custom-rules.md)
      * [Enforce your Custom Rules](scan-cloud-configurations/integrated-iac-with-cloud-context/build-your-own-iac-to-cloud-custom-rules/enforce-your-custom-rules.md)
      * [Explore example Custom Rules](scan-cloud-configurations/integrated-iac-with-cloud-context/build-your-own-iac-to-cloud-custom-rules/explore-example-custom-rules.md)
    ...
    * [View resources](scan-cloud-configurations/integrated-iac-with-cloud-context/view-resources.md)
...
* [Manage issues](manage-issues/README.md)
  ...
  * [Snyk Projects](manage-issues/introduction-to-snyk-projects/README.md)
    ...
    * [Project collections groupings](manage-issues/introduction-to-snyk-projects/project-collections-groupings/README.md)
      * [Project views](manage-issues/introduction-to-snyk-projects/project-collections-groupings/project-views.md)
      * [Project collections](manage-issues/introduction-to-snyk-projects/project-collections-groupings/project-collections.md)
  ...
  * [Insights](manage-issues/insights/README.md)
    * [How Insights works](manage-issues/insights/how-insights-works/README.md)
      * [Insights assets](manage-issues/insights/how-insights-works/insights-assets.md)
      * [Risk factors](manage-issues/insights/how-insights-works/risk-factors/README.md)
        * [OS condition](manage-issues/insights/how-insights-works/risk-factors/os-condition.md)
        * [Deployed](manage-issues/insights/how-insights-works/risk-factors/deployed.md)
        * [Public facing](manage-issues/insights/how-insights-works/risk-factors/public-facing.md)
    ...
    * [Using Insights](manage-issues/insights/using-insights/README.md)
      * [Filtering your issues](manage-issues/insights/using-insights/filtering-your-issues.md)
      * [Understanding your issues](manage-issues/insights/using-insights/understanding-your-issues.md)
  ...
  * [Reporting](manage-issues/reporting/README.md)
    ...
    * [Legacy reports](manage-issues/reporting/legacy-reports/README.md)
      ...
      * [Legacy reports general actions](manage-issues/reporting/legacy-reports/general-actions.md)
      * [Legacy Reports Summary tab](manage-issues/reporting/legacy-reports/summary-tab.md)
      * [Legacy Reports Issues tab](manage-issues/reporting/legacy-reports/issues-tab.md)
      * [Legacy Reports Dependencies tab](manage-issues/reporting/legacy-reports/dependencies-tab.md)
      * [Legacy Reports Licenses tab](manage-issues/reporting/legacy-reports/licenses-tab.md)
